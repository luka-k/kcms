	...
	var methods={
		init:function(options){
			...
			return this.each(function(){
				...
				if ($this.data("mCustomScrollbarIndex") == 1)
				{
					var o = $('.item .active').offset();
					/*
					var name = 'logotop';
					...
					alert($('.item .active').top());
					*/
					$this.mCustomScrollbar("scrollTo",o.top-80,{trigger:"internal"});
					//document.cookie = "logotop=0";
				}
			});
		},
		update:function(){
