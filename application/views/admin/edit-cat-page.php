									...
									<table  id="sort" class="sortable" cellspacing="2" cellpadding="2" >
										...
										<?foreach($content->img as $img_item):?>
											<tr>
												...
												<td class="tb_2"><input type="radio" name="cover" <?if($img_item->cover == 1):?>checked<?endif;?> value = "<?=$img_item->id?>"/></td>
												<td class="tb_2"><a href="<?=base_url()?>admin/delete_img/cat_page/<?=$img_item->id?>">Удалить</a></td>
											</tr>
											<?$count++?>
										<?endforeach?>
									</table>
