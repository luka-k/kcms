					...
					<div id="right_col" class="col_12 back">
						<div class="col_12">						
							...
							<div class="col_4 right">
								<a href="<?=base_url()?>admin/menu_module/menu/edit/" class="button small">Создать</a>
							</div>			
						</div>
								...
								<?php foreach ($content as $item): ?>
									<tr>
										...
										<?if(isset($images)):?>
											<td class="tb_3">
												<?if($item->img <> NULL):?>
													<a href="<?=base_url()?>admin/menu_module/menu/edit/<?=$item->id?>"><img src="<?=$item->img->url?>" /></a>
												<?endif;?>
											</td>
											<td class="tb_7"><a href="<?=base_url()?>admin/menu_module/menu/edit/<?=$item->id?>"><?=$item->$name?></a></td>
										<?else:?>
											<td class="tb_9"><a href="<?=base_url()?>admin/menu_module/menu/edit/<?=$item->id?>"><?=$item->$name?></a></td>
										<?endif;?>	
