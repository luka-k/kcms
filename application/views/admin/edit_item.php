		...
		<div id="page" class="grid flex">
			<div id="wrap" class="clearfix">	
				...
				<div  class="col_12 clearfix">
					<?if(($type <> "users_groups")&&($type <> "settings")&&($type <> "slider")&&($type <> "video")):?>
					...
					<?endif;?>
					<div id="right_col" class="<?if(($type == "users_groups")||($type == "settings")||($type == "slider")||($type == "video")):?>col_12<?else:?>col_9<?endif;?> back">
						<?$tab_counter = 1?>
						<ul class="tabs left">
						...
						<?$tab_counter = 1?>
						<form method="post" accept-charset="utf-8"  enctype="multipart/form-data" id="form1" action="<?=base_url()?>admin/content/item/save/<?=$type?>/<?=$content->id?>"/>
