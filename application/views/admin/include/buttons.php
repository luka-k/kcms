<div  class="col_12">
	...
	<?if($type <> "settings"):?>
		<a href="#" class="btn small" onClick="document.forms['form1'].setAttribute('action', '<?=base_url()?>admin/content/item/save/<?=$type?>/1'); document.forms['form1'].submit()">Сохранить и выйти</a>
