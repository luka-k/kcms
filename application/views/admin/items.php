		...
		<div id="wrap" class="clearfix">	
			<? require 'include/top_menu.php' ?>
				<div  class="col_12 clearfix">
					<?if($type <> "users" && $type <> "slider" && $type <> "video" && $type <> "filials"):?>
					...
					<?endif;?>
					<div id="right_col" class="<?if($type == "users" || $type == "slider" || $type == "video" || $type == "filials"):?>col_12<?else:?>col_8<?endif;?> back">
						<div class="col_12">						
