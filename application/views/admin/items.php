									...
									<tr id="<?=$type?>-<?=$item->id?>">
										...
										<td class="tb_3">
											...
											<?if($type == "products"):?>
												...
												<div class="col_2"><input type="checkbox" id="new_<?=$counter?>" onchange="advanced('special', '<?=$item->id?>', this.checked);" <?if($item->is_new == 1):?>checked<?endif;?>/></div>
												<div class="col_10"><label for="new_<?=$counter?>">спецпредложение</label></div>
