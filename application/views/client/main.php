				...
				<div id="catologue">
					<?foreach($content as $item):?>
						<section>
							...
							<div class="add_to">	
								add to: <a href="#" style="margin-right:5px; padding-right:5px; border-right:1px solid #2e2d29;" onclick="add_to_cart('<?=$item->id?>'); return false">cart</a><a href="#" onclick="add_to_wishlist('<?=$item->id?>'); return false">wish list</a>
							</div>
						</section>						
					<?endforeach;?>
				</div>
