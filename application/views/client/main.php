					...
					<div class="special clearfix">
						...
						<div class="special-item col_3">
							...
							<div class="item-footer">
								...
								<div class="price col_6"><?= $s->price ?> руб.</div><div class="btn col_6 right"><a href="#to-cart" class="red-btn square fancybox" onclick="fancy_to_cart('<?=$s->id?>', '<?=$s->name?>', 'buy', false); return false;">купить</a></div>
							</div>
						</div>
						<? endforeach ?>
					</div>
