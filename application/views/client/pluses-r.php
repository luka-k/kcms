...
<div id="page" class="container-fluid">
  ...
  <div class="span4">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h5>Контроль</h5>
        <p>Возможность контроля посещаемости через смс уведомления</p>
      </div>
    </div>
  </div>
  <div class="span4">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h5>Статистика</h5>
        <p>Статистика посещения учащимися школы и уроков</p>
      </div>
    </div>
  </div>
  <div class="span4">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h5>Скорость</h5>
        <p>Повышение скорости обслуживания в школьном буфете </p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="span4">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h5>Учет средств</h5>
        <p>Учет и контроль за использованием средств, выделяемых на питание ребенка </p>
      </div>
    </div>
  </div>
  <div class="span4">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h5>Информация</h5>
        <p>Информация об операциях, произведенных по карте </p>
      </div>
    </div>
  </div>
  <div class="span4">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h5>Экономия</h5>
        <p>Сохранность денег выданных ребенку (отсутствие потери или кражи)  </p>
      </div>
    </div>
  </div>
</div>
