...
<i class="fa fa-envelope-o"></i> <a href="mailto:General.director@sup-ptz.ru">General.director@sup-ptz.ru</a> – Генеральный Директор компании, Виталий Рудаков<br>

<i class="fa fa-envelope-o"></i> <a href="mailto:executive.director@sup-ptz.ru">executive.director@sup-ptz.ru</a> – Исполнительный Директор, Павел Цыкарев<br>

<i class="fa fa-envelope-o"></i> <a href="mailto:info@sup-ptz.ru">info@sup-ptz.ru</a> – Офис-ассистент, Вероника Федорова
