  ...
  <div class="span12">
    <div class="blocknumber_box">
      ...
      <div class="blocknumber_content">
        <h4>Войдите в личный кабинет через форму входа вверху сайта</h4>
        <p>Введите логин (номер телефона) и пароль</p>
      </div>
    </div>
  </div>
  </div>
<img src="img/ns0.png" /><br /><br /><br /><br />
 <div class="row-fluid">
  <div class="span12">
    <div class="blocknumber_box">
      <div class="blocknumber_icon">
      ...
      <div class="blocknumber_content">
        <h4>Вы попадете в личный кабинет</h4>
        <p>В правом столбце - Ваши дети, у которых есть карты «Новый Свет». По-центру - информация о выбранном ребенке: фотография (с возможностью замены), информация о школе, классе, баланс карты с возможностью пополнения. Ниже - вся статистика по карте - пополнения баланса и расходы на питание и смс-информирование</p>
      </div>
    </div>
  </div>
  </div>
<img src="img/ns1.png" /><br /><br /><br /><br />
 <div class="row-fluid">
  <div class="span12">
    <div class="blocknumber_box">
      <div class="blocknumber_icon">
      ...
      <div class="blocknumber_content">
        <h4>Контроль меню</h4>
        <p>Вы можете указать какие блюда школьной столовой запрещены для Вашего ребенка</p>
      </div>
    </div>
  </div>
  </div>
<img src="img/ns2.png" /><br /><br /><br /><br />
 <div class="row-fluid">
  <div class="span12">
    <div class="blocknumber_box">
      <div class="blocknumber_icon">
      ...
      <div class="blocknumber_content">
        <h4>Настройки личного кабинета</h4>
        <p>Вы можете подключить или отключить смс-информирование, а также установить дневной лимит на питание в столовой ребенка</p>
      </div>
    </div>
  </div>
  </div>
