...
<body id="page-site-index" class="format-site course path-site dir-ltr lang-en yui-skin-sam yui3-skin-sam lambda-redpithemes-com pagelayout-frontpage course-1 context-2 notloggedin two-column has-region-side-pre empty-region-side-pre has-region-side-post empty-region-side-post has-region-footer-left used-region-footer-left has-region-footer-middle used-region-footer-middle has-region-footer-right used-region-footer-right has-region-hidden-dock used-region-hidden-dock layout-option-nonavbar">
    ...
    <div class="skiplinks"><a class="skip" href="#maincontent">Skip to main content</a>
    </div>
                                    ...
                                    <div class="course-content">
                                        <ul class="topics">
                                            <li id="section-0" class="section main clearfix" role="region" aria-label="Features">
                                                <div class="left side"><img width="1" height="1" class="spacer" alt="" title="" src="http://lambda.redpithemes.com/theme/image.php/lambda/core/1439469018/spacer" />
                                                </div>
                                                ...
                                                <div class="content">
                                                    <h3 class="sectionname">Смс-информирование родителей о посещаемости</h3>
                                                    <div class="summary">
...
<section id="cd-timeline">
	<div class="cd-timeline-block">
		...
		<div class="cd-timeline-content">
			<h2>Карта «Новый Свет» - пропуск в школу.</h2>
			<p>Всем ученикам школы выдается карта, которую школьники прикладывают к турникету как для прохода в школу, так и для выхода из нее. Карта выдается абсолютно бесплатно и является 
личным идентификатором учащегося.</p>
			
			<span class="cd-date"><img src="/template/client/img/icon1.png"/></span>
	...
	<div class="cd-timeline-block">
		...
		<div class="cd-timeline-content">
			<h2>Решение «СМС-информирование»</h2>
			<p>Всем ученикам школы выдается карта, которую школьники прикладывают к турникету как для прохода в школу, так и для выхода из нее. Карта выдается абсолютно бесплатно и является 
личным идентификатором учащегося.</p>
			
			<span class="cd-date"><img src="/template/client/img/icon2.png"/></span>
		</div> <!-- cd-timeline-content -->
	</div> <!-- cd-timeline-block -->
	...
	<div class="cd-timeline-block">
		...
		<div class="cd-timeline-content">
			...
			<p>Вы будете точно знать где находится Ваш ребенок, будете спокойны за него и уверены что он посещает школьные занятия.</p>
			
			<span class="cd-date"><img src="/template/client/img/icon3.png"/></span>
		</div> <!-- cd-timeline-content -->
	</div> <!-- cd-timeline-block -->	
		...
		<a href="#win3" class="order btn btn-default">Оформить заявку</a>
                                                    ...
                                                    <ul class="section img-text">
                                                        <li class="activity label modtype_label " id="module-2">
                                                            <div>
                                        ...
                                        <div class="single-section">
                                            <div class="section-navigation header headingblock"></div>
                                            <ul class="topics">
                                                <li id="section-1" class="section main clearfix" role="region" aria-label="Fully Responsive">
                                                    <div class="left side"><img width="1" height="1" class="spacer" alt="" title="" src="http://lambda.redpithemes.com/theme/image.php/lambda/core/1439469018/spacer" />
                                                    </div>
                                                    <div class="right side"><img width="1" height="1" class="spacer" alt="" title="" src="http://lambda.redpithemes.com/theme/image.php/lambda/core/1439469018/spacer" />
                                                    </div>
                                                    <div class="content">
                                                        ...
                                                        <ul class="section img-text">
                                                            <li class="activity label modtype_label " id="module-4">
                                                                <div>
                                                                    <div class="mod-indent-outer">
                                                                        <div class="mod-indent"></div>
                                                                        <div>
                                                            ...
                                                            <li class="activity label modtype_label " id="module-6">
                                                                <div>
                                                                    <div class="mod-indent-outer">
                                                                        <div class="mod-indent"></div>
                                                                        <div></div>
                            ...
                            <aside id="block-region-side-pre" class="span4 desktop-first-column pull-right block-region" data-blockregion="side-pre" data-droptarget="1"></aside>
                        </div>
                    </div>
                </div>
