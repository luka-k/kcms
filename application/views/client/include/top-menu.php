<div id="menu" class="grid clearfix">
	...
	<form action="/search/" id="searchform" method="get">
		<input type="text" id="search_input" name="q" class="search square" value="<?= isset($_GET['q']) ? $_GET['q'] : '' ?>" autocomplete="off" placeholder="Поиск по номеру или именованию" onkeypress="autocomp()"/>
