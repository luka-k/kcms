	...
	<?if($viewed):?>
		<div id="view">
			...
			<section style="margin-top:17px;">
				...
				<div class="add_to">
					add to: <a href="" style="margin-right:5px; padding-right:5px; border-right:1px solid #2e2d29;" onclick="add_to_cart('<?=$viewed->id?>', 1); return false">cart</a><a href="#" onclick="add_to_wishlist('<?=$viewed->id?>'); return false">wish list</a>
				</div>
			</section>
		</div>
	<?endif;?>
