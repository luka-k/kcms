	...
	*/
	public function import_categories($categories = array(), $need_update = FALSE, $need_create = FALSE, $need_img_upload = FALSE)
	{
		foreach($categories as $c)
		{
			...
			//тут € сознательно убрал проверку на существование картинки в массиве и и $object_id
			//типо если $need_img_upload true то соответственно эти услови€ выполн€ютс€
			if($need_img_upload)
			{
				$object_info = array(
